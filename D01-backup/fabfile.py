...
# -f：指定fab入口文件，默认入口文件名为fabfile.py。如：fab -f /home/unilog/pyproject/fabfile.py backup
#
# 可和定时任务配合使用
...
# 本地服务器
# 需要备份的目标文件夹
env.project_dev_source = ['/home/unilog/teradyne/runtime/data/']
# 备份文件压缩包临时存放位置
env.project_tar_source = '/home/unilog/backup/temp/'

# 存放备份文件服务器
# 备份文件压缩包存放位置
env.deploy_project_dir = '/home/unilog/backup/'
